...
base_path = r'D:\Graduation Project\AI-COS-Pharmacy\backend\app\domains\ai\interaction_guard.py'
pkg_path = r'D:\Graduation Project\AI_Chatbot_Package\backend\interaction_guard.py'
...
print('interaction_guard.py created and synced successfully!')
